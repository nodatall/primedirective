...
def validate_deliver_terminal_gate(errors: list[str]) -> None:
    ...
    readme_tokens = [
        ...
        "rough goal prompts",
        "optimizes rough prose into objective, plain-language summary, starting evidence, target/baseline, work loop, measurable acceptance criteria, anti-cheat criteria, explicit stop conditions, boundaries, and resume state",
