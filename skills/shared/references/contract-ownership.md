...
| `finding-disposition` | `skills/shared/references/review/finding-disposition.md` | `skills/repo-sweep/SKILL.md` | Owns finding severity, confidence, disposition, looks-bad-but-fine, and loop queue semantics. |
