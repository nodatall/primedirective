...
| `verification-pivot` | `skills/shared/references/analysis/verification-pivot.md` | `skills/first-principles-mode/SKILL.md`, `skills/fix-loop/SKILL.md` | Owns the missing-evidence trigger, probe/harness output contract, and skill behavior split between read-only analysis and execution loops. |
